...
(define-integration-test simple-integration-test-02
  ...
  (let* ((var-1 (aref *trail-array* 0)))
    ...
    (it.bese.fiveam:is (equal 'x (variable-name var-1)))
    (it.bese.fiveam:is (equal 'a (variable-value var-1)))))
...
(define-integration-test simple-integration-test-04
  ...
  (let* ((var-1 (aref *trail-array* 0)) (var-2 (aref *trail-array* 1)))
    ...
    (it.bese.fiveam:is (equal 'y (variable-name var-2)))
    (it.bese.fiveam:is (equal 'd (variable-value var-2)))))
...
(define-integration-test simple-integration-test-04a
  ...
  (let* ((var-1 (aref *trail-array* 0)) (var-2 (aref *trail-array* 1)))
    ...
    (it.bese.fiveam:is (= '1 (variable-level var-1)))
    (it.bese.fiveam:is (equal 'x (variable-name var-1)))
    (it.bese.fiveam:is (equal 'c (variable-value var-1)))
    (it.bese.fiveam:is (= '1 (variable-level var-2)))
    (it.bese.fiveam:is (equal 'y (variable-name var-2)))
    (it.bese.fiveam:is (equal 'd (variable-value var-2)))))
...
(define-integration-test simple-integration-test-09
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (= 0 *trail*))
    (it.bese.fiveam:is (= '1 (variable-level var-1)))
    (it.bese.fiveam:is (equal 'y (variable-name var-1)))
    (it.bese.fiveam:is (eql 'cons/2 (first pred-2)))
    (it.bese.fiveam:is (= '1 (variable-level var-3)))
    (it.bese.fiveam:is (equal 'x (variable-name var-3)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-3)))
    (it.bese.fiveam:is (= '2 (variable-level var-4)))
    (it.bese.fiveam:is (equal 'zs (variable-name var-4)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-4)))))
...
(define-integration-test simple-integration-test-12
  ...
  (let* ((var-1 (aref *trail-array* 0)) (var-2 (variable-value var-1)))
    ...
    (it.bese.fiveam:is (equal 'y (variable-name var-1)))
    (it.bese.fiveam:is (= '1 (variable-level var-2)))
    (it.bese.fiveam:is (equal 'x (variable-name var-2)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-2)))))
...
(define-integration-test simple-integration-test-14b
  ...
  (let* ((var-1 (aref *trail-array* 0)) (var-2 (aref *trail-array* 1)))
    ...
    (it.bese.fiveam:is (= '1 (variable-level var-2)))
    (it.bese.fiveam:is (equal 'x (variable-name var-2)))
    (it.bese.fiveam:is (equal 'b (variable-value var-2)))))
...
(define-integration-test chang&lee-test-1
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (equal 'x (variable-name var-3)))
    (it.bese.fiveam:is (= '2 (variable-level var-4)))
    (it.bese.fiveam:is (equal 'y (variable-name var-4)))
    (it.bese.fiveam:is (= '2 (variable-level var-5)))
    (it.bese.fiveam:is (equal 'v (variable-name var-5)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-5)))
    (it.bese.fiveam:is (= '3 (variable-level var-6)))
    (it.bese.fiveam:is (equal 'y (variable-name var-6)))
    (it.bese.fiveam:is (eql 'k/1 (first pred-7)))
    (it.bese.fiveam:is (= '1 (variable-level var-8)))
    (it.bese.fiveam:is (equal 'x (variable-name var-8)))
    (it.bese.fiveam:is (eql 'h/2 (first pred-9)))
    (it.bese.fiveam:is (= '2 (variable-level var-10)))
    (it.bese.fiveam:is (equal 'y (variable-name var-10)))
    (it.bese.fiveam:is (= '2 (variable-level var-11)))
    (it.bese.fiveam:is (equal 'v (variable-name var-11)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-11)))
    (it.bese.fiveam:is (= '4 (variable-level var-12)))
    (it.bese.fiveam:is (equal 'y (variable-name var-12)))
    (it.bese.fiveam:is (= '2 (variable-level var-13)))
    (it.bese.fiveam:is (equal 'v (variable-name var-13)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-13)))
    (it.bese.fiveam:is (= '1 (variable-level var-14)))
    (it.bese.fiveam:is (equal 'x (variable-name var-14)))
    (it.bese.fiveam:is (eql 'h/2 (first pred-15)))
    (it.bese.fiveam:is (= '2 (variable-level var-16)))
    (it.bese.fiveam:is (equal 'y (variable-name var-16)))
    (it.bese.fiveam:is (= '2 (variable-level var-17)))
    (it.bese.fiveam:is (equal 'v (variable-name var-17)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-17)))
    (it.bese.fiveam:is (= '4 (variable-level var-18)))
    (it.bese.fiveam:is (equal 'y (variable-name var-18)))
    (it.bese.fiveam:is (= '2 (variable-level var-19)))
    (it.bese.fiveam:is (equal 'v (variable-name var-19)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-19)))
    (it.bese.fiveam:is (= '2 (variable-level var-20)))
    (it.bese.fiveam:is (equal 'y (variable-name var-20)))
    (it.bese.fiveam:is (= '2 (variable-level var-21)))
    (it.bese.fiveam:is (equal 'v (variable-name var-21)))
    (it.bese.fiveam:is (equal 'nil (variable-value var-21)))))
...
(define-integration-test chang&lee-test-2
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (equal 'x (variable-name var-2)))
    (it.bese.fiveam:is (equal 'c (variable-value var-2)))
    (it.bese.fiveam:is (= '3 (variable-level var-3)))
    (it.bese.fiveam:is (equal 'u (variable-name var-3)))
    (it.bese.fiveam:is (equal 'e (variable-value var-3)))
    (it.bese.fiveam:is (= '5 (variable-level var-4)))
    (it.bese.fiveam:is (equal 'x (variable-name var-4)))
    (it.bese.fiveam:is (equal 'a (variable-value var-4)))
    (it.bese.fiveam:is (= '5 (variable-level var-5)))
    (it.bese.fiveam:is (equal 'y (variable-name var-5)))
    (it.bese.fiveam:is (equal 'b (variable-value var-5)))
    (it.bese.fiveam:is (= '2 (variable-level var-6)))
    (it.bese.fiveam:is (equal 'x (variable-name var-6)))
    (it.bese.fiveam:is (equal 'c (variable-value var-6)))
    (it.bese.fiveam:is (= '3 (variable-level var-7)))
    (it.bese.fiveam:is (equal 'z (variable-name var-7)))
    (it.bese.fiveam:is (equal 'b (variable-value var-7)))
    (it.bese.fiveam:is (= '5 (variable-level var-8)))
    (it.bese.fiveam:is (equal 'v (variable-name var-8)))
    (it.bese.fiveam:is (equal 'e (variable-value var-8)))
    (it.bese.fiveam:is (= '2 (variable-level var-9)))
    (it.bese.fiveam:is (equal 'y (variable-name var-9)))
    (it.bese.fiveam:is (equal 'a (variable-value var-9)))
    (it.bese.fiveam:is (= '2 (variable-level var-10)))
    (it.bese.fiveam:is (equal 'v (variable-name var-10)))
    (it.bese.fiveam:is (equal 'e (variable-value var-10)))))
...
(define-integration-test chang&lee-test-3
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (= '3 (variable-level var-7)))
    (it.bese.fiveam:is (equal 'z (variable-name var-7)))
    (it.bese.fiveam:is (equal 'a (variable-value var-7)))
    (it.bese.fiveam:is (= '3 (variable-level var-8)))
    (it.bese.fiveam:is (equal 'u (variable-name var-8)))
    (it.bese.fiveam:is (equal 'e (variable-value var-8)))
    (it.bese.fiveam:is (= '3 (variable-level var-9)))
    (it.bese.fiveam:is (equal 'y (variable-name var-9)))
    (it.bese.fiveam:is (eql 'i/1 (first pred-10)))
    (it.bese.fiveam:is (= '5 (variable-level var-11)))
    (it.bese.fiveam:is (equal 'x (variable-name var-11)))
    (it.bese.fiveam:is (= '3 (variable-level var-12)))
    (it.bese.fiveam:is (equal 'z (variable-name var-12)))
    (it.bese.fiveam:is (equal 'a (variable-value var-12)))
    (it.bese.fiveam:is (= '2 (variable-level var-13)))
    (it.bese.fiveam:is (equal 'y (variable-name var-13)))
    (it.bese.fiveam:is (equal 'e (variable-value var-13)))
    (it.bese.fiveam:is (= '3 (variable-level var-14)))
    (it.bese.fiveam:is (equal 'z (variable-name var-14)))
    (it.bese.fiveam:is (equal 'a (variable-value var-14)))
    (it.bese.fiveam:is (= '2 (variable-level var-15)))
    (it.bese.fiveam:is (equal 'v (variable-name var-15)))
    (it.bese.fiveam:is (equal 'e (variable-value var-15)))
    ...
    (it.bese.fiveam:is (equal 'x (variable-name var-18)))
    (it.bese.fiveam:is (= '3 (variable-level var-19)))
    (it.bese.fiveam:is (equal 'z (variable-name var-19)))
    (it.bese.fiveam:is (equal 'a (variable-value var-19)))
    (it.bese.fiveam:is (= '8 (variable-level var-20)))
    (it.bese.fiveam:is (equal 'u (variable-name var-20)))
    (it.bese.fiveam:is (equal 'e (variable-value var-20)))
    (it.bese.fiveam:is (= '8 (variable-level var-21)))
    (it.bese.fiveam:is (equal 'z (variable-name var-21)))
    (it.bese.fiveam:is (equal 'a (variable-value var-21)))))
...
(define-integration-test chang&lee-test-4
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (equal 'x (variable-name var-16)))
    (it.bese.fiveam:is (eql 'i/1 (first pred-17)))
    (it.bese.fiveam:is (= '5 (variable-level var-18)))
    (it.bese.fiveam:is (equal 'x (variable-name var-18)))
    (it.bese.fiveam:is (= '3 (variable-level var-19)))
    ...
    (it.bese.fiveam:is (equal 'x (variable-name var-20)))
    (it.bese.fiveam:is (eql 'i/1 (first pred-21)))
    (it.bese.fiveam:is (= '5 (variable-level var-22)))
    (it.bese.fiveam:is (equal 'x (variable-name var-22)))
    (it.bese.fiveam:is (= '3 (variable-level var-23)))
    (it.bese.fiveam:is (equal 'z (variable-name var-23)))
    (it.bese.fiveam:is (equal 'a (variable-value var-23)))))
...
(define-integration-test chang&lee-test-5
  ...
  (let* ((var-1 (aref *trail-array* 0)) (var-2 (aref *trail-array* 1)))
    ...
    (it.bese.fiveam:is (= '2 (variable-level var-2)))
    (it.bese.fiveam:is (equal 'y (variable-name var-2)))
    (it.bese.fiveam:is (equal 'a (variable-value var-2)))))
...
(define-integration-test chang&lee-test-7
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (= 2 *trail*))
    (it.bese.fiveam:is (= '2 (variable-level var-1)))
    (it.bese.fiveam:is (equal 'z (variable-name var-1)))
    (it.bese.fiveam:is (equal 'b (variable-value var-1)))
    (it.bese.fiveam:is (= '2 (variable-level var-2)))
    (it.bese.fiveam:is (equal 'u (variable-name var-2)))
    (it.bese.fiveam:is (eql 's/1 (first pred-3)))
    (it.bese.fiveam:is (equal 'b (nth 1 pred-3)))
    (it.bese.fiveam:is (= '5 (variable-level var-4)))
    (it.bese.fiveam:is (equal 'y (variable-name var-4)))
    (it.bese.fiveam:is (eql 's/1 (first pred-5)))
    (it.bese.fiveam:is (equal 'c (nth 1 pred-5)))))
...
(define-integration-test chang&lee-test-9
  ...
  (let* ((var-1 (aref *trail-array* 0))
    ...
    (it.bese.fiveam:is (= '3 (variable-level var-3)))
    (it.bese.fiveam:is (equal 'y (variable-name var-3)))
    (it.bese.fiveam:is (equal 'a (variable-value var-3)))
    (it.bese.fiveam:is (= '3 (variable-level var-4)))
    (it.bese.fiveam:is (equal 'y (variable-name var-4)))
    (it.bese.fiveam:is (equal 'a (variable-value var-4)))))
